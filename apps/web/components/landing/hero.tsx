...
export const Hero = () => {
  return (
    <div className="max-w-[400px] text-center mx-auto relative mt-32">
      <span className="font-serif text-5xl leading-12">
        A place to write, publish, & share your thoughts.
      </span>
      <p className="mt-5 text-muted-foreground">
        Share your stories, grow your audience, and join a community of
